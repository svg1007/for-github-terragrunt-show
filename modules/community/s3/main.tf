  ...
  dynamic "rule" {
    ...
    content {
      ...
      dynamic "apply_server_side_encryption_by_default" {
        ...
        content {
          sse_algorithm     = try(apply_server_side_encryption_by_default.value.sse_algorithm, "aws:kms")
          kms_master_key_id = try(apply_server_side_encryption_by_default.value.kms_master_key_id, "aws/s3")
        }
      }
    }
  }
